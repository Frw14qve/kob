                ...
                <div class="card" style="margin-top:20px">
                    <div class="card-header">
                        ...
                        <button type="button" class="btn btn-primary float-end">
                            <span style="font-size: 100%" data-bs-toggle="modal" data-bs-target="#add-bot-btn">创建Bot</span> 
                        </button>
                    ...
                    <textarea v-model="botadd.description" class="form-control" id="add-bot-description" placeholder="请输入Bot简介" rows="3"></textarea>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                    <label for="add-bot-description" class="form-label">Bot简介</label>
                    <textarea v-model="bot.description" class="form-control" id="add-bot-description" placeholder="请输入Bot简介" rows="3"></textarea>
                    </div>
                    <div class="mb-3">
                    <label for="add-bot-code" class="form-label">代码</label>
                    <VAceEditor
...
export default{
    ...
    "https://cdn.jsdelivr.net/npm/ace-builds@" + require('ace-builds').version + "/src-noconflict/")
        const refresh_bots = () => {
            $.ajax({
                url:"https://app3316.acapp.acwing.com.cn/api/user/bot/getlist/",
                type:"get",
                headers:{
        ...
        const add_bot = () =>{
            ...
            $.ajax({
                url:"https://app3316.acapp.acwing.com.cn/api/user/bot/add/",
                type:"post",
                data:{
                    title: botadd.title,
    ...
    const remove_bot = (bot) => {
        $.ajax({
                url:"https://app3316.acapp.acwing.com.cn/api/user/bot/remove/",
                type:"post",
                data:{
                    bot_id:bot.id,
                },
    ...
    const update_bot = (bot) =>{
            botadd.error_message="";
            $.ajax({
                url:"https://app3316.acapp.acwing.com.cn/api/user/bot/update/",
                type:"post",
                data:{
                    bot_id:bot.id,
                    title: bot.title,
